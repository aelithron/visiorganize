...
export default function SharedMessage({ project, user }: { project: Project, user: User }) {
  if (project.sharedWith === undefined) return <span className="text-sm text-slate-600 dark:text-slate-400"><FontAwesomeIcon icon={faLock} className="mr-[2px]" /> Not shared</span>
